...
export function Navbar() {
  ...
  const isActuallyHydrated =
    _hasHydrated ||
    (typeof window !== "undefined" && useAuthStore.persist.hasHydrated());
  const showAuthUI =
    mounted && isActuallyHydrated && isAuthenticated && user && !isLoading;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              >
                Leapfrog
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0A5C4A] to-[#1E88E5] dark:from-[#10B981] dark:to-[#3B82F6]">
                  Connect
                </span>
              </motion.span>
            </Link>
          ...
          {isDashboard && (
            <div className="hidden md:flex flex-1 max-w-md relative group">
              <Search
                size={18}
                className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--color-text-secondary)] group-focus-within:text-[var(--color-primary)] transition-colors"
              />
              <input
                type="text"
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between p-5 border-b border-[var(--color-border)]">
                ...
                <button
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-9 h-9 rounded-xl flex items-center justify-center hover:bg-[var(--color-muted)] transition-colors"
                >
