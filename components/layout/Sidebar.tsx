...
export function Sidebar() {
  ...
  const SidebarContent = ({ mobile = false }: { mobile?: boolean }) => (
    <div className="flex flex-col h-full bg-[var(--color-bg-sidebar)]">
      {/* Logo */}
      <div className={cn('flex items-center gap-4 px-7 py-8 border-b border-[var(--color-border)]/50', sidebarCollapsed && !mobile && 'justify-center px-2')}>
        <div className="w-10 h-10 rounded-2xl bg-[var(--color-primary)] flex items-center justify-center flex-shrink-0 shadow-lg shadow-[var(--color-primary)]/30">
