...
const variants = {
  primary:
    "bg-[var(--color-primary)] text-white hover:opacity-90 shadow-[var(--shadow-sm)]",
  secondary:
    "bg-[var(--color-secondary)] text-white hover:opacity-90 shadow-[var(--shadow-sm)]",
  outline:
    "border-2 border-[var(--color-border)] text-[var(--color-text-primary)] hover:bg-[var(--color-muted)]",
  ghost:
